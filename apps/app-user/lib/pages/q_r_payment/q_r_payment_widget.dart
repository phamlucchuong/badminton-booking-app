                                          ...
                                          child: Container(
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  '\$${functions.bookingTotalPrice(FFAppState().cartAddons.toList(), FFAppState().selectedSlots.toList()).toString()}',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .titleLarge
                                                      .override(
                        ...
                        children: [
                          InkWell(
                            ...
                            child: wrapWithModel(
                              ...
                              updateCallback: () => safeSetState(() {}),
                              child: ButtonWidget(
                                content: 'Confirm Payment Completed',
                                iconPresent: false,
